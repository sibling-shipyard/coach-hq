...
Consult `injury_flags[]` and `conditions[]` in `training/coach/state.md` (Active Injury Flags and chronic constraints); match active entries to the patterns below:
...
1. Read `injury_flags[]` / Active Injury Flags in `training/coach/state.md`.
...
3. Check `injury_flags[]` / Active Injury Flags in `training/coach/state.md` and pre-apply modifications to the plan.
...
3. Check `injury_flags[]` / Active Injury Flags in `training/coach/state.md` and pre-apply any modifications.
...
7. Update `injury_flags[]` / Active Injury Flags in `training/coach/state.md` if anything changed.
