...
- **Decision:** Write the gates into the docs instead — a typed phase table in `kdb/doc-style.md`, and a freshness gate, a fixed report shape, a retry cap of 2, and seven countable review checks in `.github/agents/tech-lead.md`.
