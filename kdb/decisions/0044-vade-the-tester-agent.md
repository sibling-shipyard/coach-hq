...
- **How to apply:** Full design in `docs/plans/vade-the-tester.md` while the plan is in flight; once it lands, `.github/agents/vade-the-tester.md` is the scope of record.
