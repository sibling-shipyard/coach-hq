...
| G4  | First Session timezone guard misses "I live in ...". "I'm from ..." is origin, not residence, so it stays out. | Timezone is required for completion                                         | Add only "I live in" and similar residence phrasing (4, 5) |
