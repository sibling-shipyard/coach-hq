...
| H1 | H — Final consistency | Every doc and SOUL layer reflects the shipped state | J2 | `docs/eng-docs/*`, `platform/soul/B_engine.md`, `SOUL_HISTORY.md` | [`ccr-h1-docs-soul-consistency-lld.md`](ccr-h1-docs-soul-consistency-lld.md) | Closes #735 |
