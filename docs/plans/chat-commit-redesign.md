...
| D2 | D — Reliability | GitHub + backend latency visible in Sentry, validation failures captured | D1 | `ui/api/_lib/sentry.ts` | [`ccr-d2-sentry-latency-lld.md`](ccr-d2-sentry-latency-lld.md) | Matches existing Gemini latency instrumentation |
