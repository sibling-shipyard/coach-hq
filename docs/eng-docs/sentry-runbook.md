...
> Status: Current · Owner: Tech Lead · Verified: 2026-09-16 · ADR: [0032](../../kdb/decisions/0032-sentry-data-rules.md), [0049](../../kdb/decisions/0049-python-pipeline-sentry-scope.md)
>
...
- **Python pipeline entry points** (`engine/`, `scripts/`) beyond the Sync-workflow envelope POST
  (`notify_sync_failure.py`). ADR 0032 names web/API/iOS only; ADR 0049 settles Python — no
  `sentry_sdk`, the workflow envelope is the whole story. Correctness bugs that never throw
