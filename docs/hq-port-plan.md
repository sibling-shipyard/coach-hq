...
|---|---|---|---|
| **P1** | S | Additive port | `core/`, `plugins/` (badminton + taxonomy), `archive/`, `tests/`, `SOUL_HISTORY.md`, `soul/` split, kebab doc renames landed. hq builds, site deploys unchanged. Verify no hq TS already computes badminton analytics (avoid a dupe). |
