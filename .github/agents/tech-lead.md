...
- Soul: edit `platform/soul/*.md` layers → `node platform/scripts/compose-soul.mjs` → commit layers + `platform/propagated/SOUL.md` — never hand-edit composed SOUL.
...
- `platform/soul/*.md` and composed `platform/propagated/SOUL.md` are **Tech Lead only** — never edit as Coach.
...
2. Read `AGENTS.md` (routing + KB index) + `platform/propagated/SOUL.md` (the coaching system)
