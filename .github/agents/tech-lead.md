...
- Soul: edit `engine/soul/*.md` layers → `node engine/scripts/compose-soul.mjs` → commit layers + `propagated/SOUL.md` — never hand-edit composed SOUL.
...
- `engine/soul/*.md` and composed `propagated/SOUL.md` are **Tech Lead only** — never edit as Coach.
