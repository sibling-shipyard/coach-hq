...
- **Don't touch:** `ui/` (UI Expert), `ios/` (iOS Builder), `engine/templates/*.json` (Tech Lead), coaching files (`user_data/coach/`, `sessions/`, `user_data/ledger/challenge_v2.json` — Coach), `platform/soul/` + `propagated/SOUL.md` (Tech Lead).
