#!/usr/bin/env node
/**
 * Pre-build bundle for engine/lib/current-week.mts.
 *
 ...
 * Same problem/fix shape as bundle-widget-snapshots-api.mjs, just a different cross-band source.
 */
...
const entry = path.join(uiRoot, "../engine/lib/current-week.mts");
const outfile = path.join(uiRoot, "api/coach-chat/_lib/_generated/current-week.bundle.js");
