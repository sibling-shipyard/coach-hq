      ...
      : mode === "activity_sync"
        ...
        : firstSession
          ? [
              ...
              "pushed; season_start (with the main goal bundled into its main_quest field) as",
              ...
              "\nseason_start and quest_create are two separate fields, and a goal plus daily habits",
              "often arrive in the same message. Firing season_start does not cover quest_create - if",
              "the athlete named daily habits in this turn, quest_create must also be set in this same",
              "response, even though season_start already fired for the goal. This is the field most",
              "likely to get missed: describing the habits as saved in your reply text is not the same",
              "as setting quest_create, and doing only the former silently drops them.",
          ...
          : [
              ...
              "\nseason_start and quest_create are two separate fields, and a new goal plus new daily",
              "habits often arrive in the same message. Firing season_start for the new season does",
              "not cover quest_create - if the athlete also named new daily habits in this turn,",
              "quest_create must be set in this same response too. This is the field most likely to",
              "get missed: describing the habits as saved in your reply text is not the same as",
              "setting quest_create, and doing only the former silently drops them.",
