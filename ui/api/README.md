...
for the catch-all pattern (`auth/[...action].ts`) used to stay under that cap. Currently 9 routed
...
| `sentry-check.ts`                 | **Temporary** — throws on purpose to prove Sentry capture; deleted in Phase 2 of `docs/plans/sentry-lld.md` |
