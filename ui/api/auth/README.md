...
| `github-aggregate.ts` | Fetches `gen/aggregate.json` from an athlete repo via the GitHub Contents API |
| `generate-widget-snapshots-from-aggregate.ts` | Runs Warm Instrument snapshot models against a fetched aggregate bundle (ADR 0005) |
