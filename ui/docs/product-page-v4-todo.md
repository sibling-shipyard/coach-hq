...
- [x] **1** Real widgets in highlights, not CSS facsimiles _(A1–A2)_
- [x] **2** Engine hero: per-week Newsreader verdicts on scrub + draw-on-enter line + discrete hover zones
- [x] **3** Coach section (`#coach`): redesign or relocate; crossfade on quote pick _(moved after highlights)_
...
- [x] **6** Engine discrete scrub zones _(merged into #2)_
- [x] **7** Carousel UX: prev/next arrows, keyboard ←/→, `aria-live` on slide change _(A3)_
...
- [x] **12** Consistency grid stagger _(TrainingActivityCard compact + staggerCells)_
- [x] **13** Section rhythm: light/dark alternation _(coach moved after highlights — intentional)_
