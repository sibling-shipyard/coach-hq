...
| `scripts/` | Build-time and operator scripts — `build/build-data.mjs` (pre-build data generation), `build/build-soul.mjs` (bundles `platform/SOUL.chat.md`), migration scripts.                                      |
| `eval/`    | Eval harness and manual test drivers — `eval-coach-chat.ts` (paid/live Gemini eval gate), transcripts, examples.                                                                                        |
