...
function copyPropagated(outDir) {
  const soulSrc = path.join(REPO_ROOT, "platform", "artifacts", "propagated", "SOUL.md");
  if (!fs.existsSync(soulSrc)) {
    throw new Error("Missing platform/artifacts/propagated/SOUL.md — run compose-soul before carve");
  }
